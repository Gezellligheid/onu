// Builds the per-room OG/link-preview image as an SVG string (rasterized to
// PNG by sharp in index.js). This is a deployed copy of
// scripts/og-image-svg.mjs — kept separate because Firebase only uploads
// this functions/ directory on deploy, so it can't reach outside it at
// runtime. Keep the two in sync by hand if you touch the branding.
